...
import static de.eldoria.bloodnight.config.worldsettings.mobsettings.VanillaDropMode.*;
import static de.eldoria.bloodnight.config.worldsettings.mobsettings.VanillaDropMode.COMBINE;
